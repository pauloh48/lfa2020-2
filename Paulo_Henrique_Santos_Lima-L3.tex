...
%
  \begin{description}[topsep=0pt,noitemsep,labelwidth=\widthof{ER =},labelindent=2.5\labelwidth,leftmargin=*,align=right]
   \item [ER($\mathcal{L}_\myling$) =] $(0^*1^*(10)0^*1^*(10))^*(0^*1^*)$.
  \end{description}
  }
% 
 \end{itemize}
